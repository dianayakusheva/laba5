...
public class GraphicsDisplay1 extends JPanel {
    ...
    public void zoomToRegion(double x1,double y1,double x2,double y2)	{ //увеличение области
    ...
    protected void paintComponent(Graphics g) { //модульный метод, определяет размер отображаемой области пространства,
//вычисляет коэффиценты масштаба, при необходимости вызывает доп методы отображния
    ...
    //Приближаем
    protected int findSelectedPoint(int x, int y) //нахождение выделенного элемента
    {
    ...
    public class MouseHandler extends MouseAdapter {
        ...
        public void mouseClicked(MouseEvent ev) {//метод для отслеживания состояния кнопок мыши (нажатие)
            if (ev.getButton() == 3) {
        ...
        public void mousePressed(MouseEvent ev) {//метод для отслеживания состояния кнопок мыши (При наведении курсора мыши на маркер какой-либо точки рядом с ним отображались значения координат (X,Y) в данной точке)
        ...
        public void mouseReleased(MouseEvent ev) {//метод для отслеживания состояния кнопок мыши
            if (ev.getButton() != 1) return;
    ...
    public class MouseMotionHandler implements MouseMotionListener {
        ...
        public void mouseDragged(MouseEvent ev) {//метод для отслеживания координат курсора мыши
            if (changeMode) {
